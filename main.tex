...
\title{NautDB: Towards a Hybrid Runtime for Query Processing}
...
\begin{frame}[t] % The whole poster is enclosed in one beamer frame
  ...
  \begin{columns}[t]
    ...
    \begin{column}{\onecolwid}
      \begin{figure}
        \includegraphics[height=30cm]{malloc.png}
        \label{fig:1}
        \textrm{\caption{An alternative memory allocator can have a better performance for certain workloads.}}
      \end{figure}
    ...
    % column 3
    \begin{column}{\onecolwid}
      \input{preliminary_results_I.tex}
      \input{preliminary_results_II.tex}
    \end{column}
